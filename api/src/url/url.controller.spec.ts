...
describe('UrlController', () => {
    ...
    describe('redirectToLongUrl', () => {
      it('should return a redirect URL', async () => {
        ...
        const result = await urlController.redirectToLongUrl(code);
    ...
    describe('shortenUrl', () => {
      it('should return a shortened URL', async () => {
        const longUrl = 'https://medium.com/equify-tech/the-three-fundamental-stages-of-an-engineering-career-54dac732fc74';
        const shortUrl = `http://${process.env.API_URL}/ptl0PV`;

        const result = await urlController.shortenUrl( longUrl );
